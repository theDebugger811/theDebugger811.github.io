...
1. Git fork the code, and then clone the *forked repository*.
2. The latest push now works with Python 3.8
3. The Next Steps of Milestone 1 have been added.

###### Working with (15.04.2021)
MacOS 10.15.7 + Conda (Python3.6 & Python3.8) ✅
Ubuntu 18.04 + Virtualenv (Python3.6 & Python3.8) ✅
Windows + Conda (Python3.6 & Python3.8) (TBC)
...
1. Added 2-3 visualizations (obtained using previous command) qualitatively comparing outputs of the vanilla model and D-Grid model (using goal information) in the README file of your forked repository.
...
```
4. Final Step: Upload the predictions of D-Grid on [AICrowd](https://www.aicrowd.com/challenges/trajnet-a-trajectory-forecasting-challenge). A note to do so will be out soon! :)
